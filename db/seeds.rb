...
review5 = product5.reviews.create!({
  user_id: 1,
  description: 'This thing is really great.',
  rating: 5
})

review6 = product6.reviews.create!({
  user_id: 1,
  description: 'This thing is pretty good.',
  rating: 4
})

review7 = product7.reviews.create!({
  user_id: 1,
  description: 'This thing is really great.',
  rating: 5
})

review8 = product8.reviews.create!({
  user_id: 1,
  description: 'This thing is pretty good.',
  rating: 4
})

review9 = product9.reviews.create!({
  user_id: 1,
  description: 'This thing is really great.',
  rating: 5
})

review10 = product10.reviews.create!({
  user_id: 1,
  description: 'This thing is pretty good.',
  rating: 4
})

review11 = product11.reviews.create!({
  user_id: 1,
  description: 'This thing is really great.',
  rating: 5
})

review12 = product12.reviews.create!({
  user_id: 1,
  description: 'This thing is pretty good.',
  rating: 4
})
